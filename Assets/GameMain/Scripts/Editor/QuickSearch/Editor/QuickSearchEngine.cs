...
namespace QuickSearch
{
    ...
    public class QuickSearchEngine
    {
        ...
        public static QuickSearchEngine Instance
        {
        ...
        private void CalculateMatchScore(List<ISearchableElement> elements, string query_lower,
            List<MatchPair> outToAppend)
        {
            for (var i = 0; i < elements.Count; ++i)
            {
                ...
                {
                    var secondaryScore =
                        CalculateMatchScore(element.SecondaryContents.ToLowerInvariant(), query_lower) * 0.9f;
