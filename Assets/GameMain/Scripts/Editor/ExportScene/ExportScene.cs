namespace SG1
{
    ...
    public class ExportScene : EditorWindow
    {
        ...
        [MenuItem("GameObject",true)]
        [MenuItem("ExportScene",true)]
        [MenuItem("ExportScene/ExportSceneToObj",true)]
        [MenuItem("GameObject/ExportScene/ExportSceneToObj",true)]
        [MenuItem("ExportScene/ExportSceneToObj(AutoCut)",true)]
        [MenuItem("GameObject/ExportScene/ExportSceneToObj(AutoCut)",true)]
        [MenuItem("ExportScene/ExportSelectedObj",true)]
        [MenuItem("GameObject/ExportScene/ExportSelectedObj",true, priority = 44)]
        public static bool Funtion()
        {
            return false;
        }
